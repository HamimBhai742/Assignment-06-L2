  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setStats({
        ...
        transactionChart: [
          { month: 'Sun', transactions: 3200, volume: 185000 },
          { month: 'Mon', transactions: 3800, volume: 220000 },
          { month: 'Tue', transactions: 4200, volume: 245000 },
          { month: 'Wed', transactions: 3900, volume: 235000 },
          { month: 'Thr', transactions: 4500, volume: 280000 },
          { month: 'Fri', transactions: 5100, volume: 320000 },
          { month: 'Sat', transactions: 4800, volume: 295000 },
          { month: 'Sun', transactions: 3200, volume: 185000 },
          { month: 'Mon', transactions: 3800, volume: 220000 },
          { month: 'Tue', transactions: 4200, volume: 245000 },
        ...
        volumeDistribution: [
          { name: 'Send Money', value: 1250000, color: '' },
          { name: 'Cash In', value: 850000, color: '' },
          { name: 'Cash Out', value: 520000, color: '' },
          { name: 'Bill Payment', value: 227593, color: '' },
        ],
      });
      setIsLoading(false);
    }, 1000);
