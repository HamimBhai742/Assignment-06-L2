    ...
    <div className='space-y-6'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
        ...
        <div className='mt-4 sm:mt-0 flex items-center space-x-3'>
          ...
          <button className='px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm font-medium bg-white dark:bg-gray-800'>
            📄 Statement
          </button>
        </div>
      </div>
