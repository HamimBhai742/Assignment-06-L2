        ...
        {showChangePIN && (
          <div className='space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700'>
            ...
            <button
              ...
              className='w-full bg-green-600 dark:bg-green-700 text-white py-3 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors disabled:opacity-50'
            >
