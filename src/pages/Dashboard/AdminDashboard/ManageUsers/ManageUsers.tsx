...
const ManageUsers = () => {
        ...
        <div className='bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700'>
          <div className='space-y-4'>
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className='flex items-center space-x-4 p-4 border border-gray-100 dark:border-gray-700 rounded-xl animate-pulse'
              >
  ...
  return (
    <div className='space-y-6 dark:bg-gray-900'>
      ...
      {/* Results */}
      <div className='bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden'>
        {users?.length === 0 ? (
          <div className='text-center py-12'>
            <MagnifyingGlassIcon className='h-12 w-12 dark:text-white text-gray-400 mx-auto mb-4' />
