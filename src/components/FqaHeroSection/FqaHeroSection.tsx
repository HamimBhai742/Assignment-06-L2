      ...
      <div className='relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
        ...
        <div className='relative max-w-2xl mx-auto mb-8'>
          ...
          <input
            ...
            className='w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent'
          />
        </div>
