          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <button
                ...
                className='w-full bg-blue-600  text-white py-4 px-8 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 focus:ring-4 focus:ring-blue-300 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center'
              >
                {isSubmitting ? (
                  <>
                    <svg
